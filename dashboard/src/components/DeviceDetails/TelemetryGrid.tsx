...
import { AlertTriangle, Wrench, Thermometer, Droplets, BatteryCharging, Zap, RotateCw, Wifi } from 'lucide-react';
...
const TelemetryGrid: React.FC<TelemetryGridProps> = ({ device, isManager }) => {
