...
const DeviceCharts: React.FC<DeviceChartsProps> = ({
    device,
    history,
    tempMin,
    tempMax
            ...
            <div className="flex items-center justify-between mb-8">
                ...
                <div className="flex gap-2">
                    {device?.status === 'online' && (
                        <span className="text-[10px] font-bold px-3 py-1.5 bg-primary text-background-dark rounded-lg uppercase tracking-widest shadow-lg shadow-primary/20">
                            Ao Vivo
                        </span>
                    )}
                </div>
                    ...
                    <AreaChart data={history && history.length > 0 ? history : []}>
                        ...
                        {tempMin && (
                            <ReferenceLine
                                ...
                                stroke="#ef4444"
                                strokeDasharray="3 3"
                                label={{ position: 'insideBottomRight', value: 'Mín', fill: '#ef4444', fontSize: 9 }}
                            />
                        )}
                        {tempMax && (
                            <ReferenceLine
                                ...
                                stroke="#ef4444"
                                strokeDasharray="3 3"
                                label={{ position: 'insideTopRight', value: 'Máx', fill: '#ef4444', fontSize: 9 }}
                            />
                        )}
