...
async function test() {
    const { data: data8 } = await supabase.from('telemetry').select('*').gte('hora_registro', '08:00:00').lt('hora_registro', '09:00:00').limit(5);
    console.log("Records starting with 08:", data8);
}
test();
